<script>
    import { marchingCubes } from "./marchingCubes2";
    ...
    let minimum_percent = 0.00000001;
    let smoothness = 0.01;
...
<div
    class="flex place-items-center place-content-center h-full w-full flex-row"
    in:fade={{ duration: 600 }}
    out:fade={{ duration: 300 }}
>
    <div
        class="w-72 h-full bg-gray-50 flex flex-col py-12 px-6 gap-6 overflow-scroll"
    >
        ...
        <div class="pt-6">
            ...
            {/if}
            <div class="text-sm text-gray-400 mt-1">
                it might take a while to calculate! (the website will freeze
                when calculating)
            </div>
        </div>
    </div>
